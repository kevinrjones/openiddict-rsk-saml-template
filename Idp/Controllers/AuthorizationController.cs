...
public class AuthorizationController : Controller
{
    ...
    public async Task<IActionResult> Authorize()
    {
        ...
        ImmutableArray<string> roles =ImmutableArray<string>.Empty;
    ...
    [HttpGet("~/connect/saml/logout")]
    public IActionResult SamlLogout(string logoutId, string requestId) => View();
