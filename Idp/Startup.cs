        ...
        services.AddOpenIddict()
            ...
            .AddServer(options =>
            {
                ...
                options.AddSamlPlugin(builder =>
                {
                    ...
                    //use quartz to prune old SAML artifacts every 14 days.
                    ...
                    builder.UseSamlEntityFrameworkCore()
                        ...
                        {
                            //Configure the database provider to use.
optionsBuilder.UseMySql(defaultConnectionString, ServerVersion.AutoDetect(defaultConnectionString), x =>x.MigrationsAssembly(typeof(Startup).Assembly.FullName));
                        });
